...
public class JavaScriptAlertsPage extends BasePage {
    ...
    public void clickAlertButton() {
        Allure.step("Click JS Alert button", () ->
                Objects.requireNonNull(wait.until(ExpectedConditions.elementToBeClickable(alertButton))).click()
        );
    }
    ...
    public void clickConfirmButton() {
        Allure.step("Click JS Confirm button", () ->
                Objects.requireNonNull(wait.until(ExpectedConditions.elementToBeClickable(confirmButton))).click()
        );
    }
    ...
    public void clickPromptButton() {
        Allure.step("Click JS Prompt button", () ->
                Objects.requireNonNull(wait.until(ExpectedConditions.elementToBeClickable(promptButton))).click()
        );
    }
    ...
    public void acceptJavaScriptAlert() {
        Allure.step("Accept JavaScript alert", () ->
                Objects.requireNonNull(wait.until(ExpectedConditions.alertIsPresent())).accept()
        );
    }
    ...
    public void dismissJavaScriptAlert() {
        Allure.step("Dismiss JavaScript alert", () ->
                Objects.requireNonNull(wait.until(ExpectedConditions.alertIsPresent())).dismiss()
        );
    }

    // Returns the text of the JavaScript alert
    public String getAlertText() {
        return Objects.requireNonNull(wait.until(ExpectedConditions.alertIsPresent())).getText();
    }
    ...
    public void setAlertInputText(String inputText) {
        Allure.step("Set alert input text: " + inputText, () ->
                Objects.requireNonNull(wait.until(ExpectedConditions.alertIsPresent())).sendKeys(inputText)
        );
    }

    // Returns the text of the result element on the page
    private String getAlertResultText() {
        return Objects.requireNonNull(wait.until(ExpectedConditions.visibilityOfElementLocated(result))).getText().trim();
    }
}
